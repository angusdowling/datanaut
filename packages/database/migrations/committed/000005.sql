--! Previous: sha1:4995433776ae0b4028d4aae3bbba3b4a310ce0cc
--! Hash: sha1:a54624fef2adaecb5d67c7b2d0ab1e87515fb7d6
...
BEGIN
    IF EXISTS (
        ...
        WHERE event_object_table = 'app_rows' 
        AND trigger_name = 'validate_app_rows_data'
    ) THEN
