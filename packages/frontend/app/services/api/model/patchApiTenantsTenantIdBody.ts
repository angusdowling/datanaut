 ...
 */
import type { PatchApiTenantsTenantIdBodyData } from "./patchApiTenantsTenantIdBodyData";

export type PatchApiTenantsTenantIdBody = {
  data: PatchApiTenantsTenantIdBodyData;
};
