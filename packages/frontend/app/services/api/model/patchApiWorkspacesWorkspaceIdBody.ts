 ...
 */
import type { PatchApiWorkspacesWorkspaceIdBodyData } from "./patchApiWorkspacesWorkspaceIdBodyData";

export type PatchApiWorkspacesWorkspaceIdBody = {
  /** Workspace update data */
  data: PatchApiWorkspacesWorkspaceIdBodyData;
};
